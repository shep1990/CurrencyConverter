...
namespace CurrencyConverter.Domain.Migrations
{
    ...
    [Migration("20200526145243_CurrencyLogging_UpdatedRelationshipDefinition")]
    partial class CurrencyLogging_UpdatedRelationshipDefinition
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CurrencyConverter.Domain.Data.CurrencyLoggingEntity", b =>
                {
                    b.HasOne("CurrencyConverter.Domain.Data.CurrencyEntity", "SourceCurrency")
                        .WithMany()
                        .HasForeignKey("SourceCurrencyId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CurrencyConverter.Domain.Data.CurrencyEntity", "TargetCurrency")
                        .WithMany()
